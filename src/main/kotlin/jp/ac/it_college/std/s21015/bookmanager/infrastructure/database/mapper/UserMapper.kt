...
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.mapper.UserDynamicSqlSupport.email
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.mapper.UserDynamicSqlSupport.id
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.mapper.UserDynamicSqlSupport.name
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.mapper.UserDynamicSqlSupport.password
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.mapper.UserDynamicSqlSupport.roleType
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.mapper.UserDynamicSqlSupport.user
import jp.ac.it_college.std.s21015.bookmanager.infrastructure.database.record.User
